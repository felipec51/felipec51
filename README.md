...
> Soy un desarrollador apasionado por **Frontend** e **Inteligencia Artificial**.
> Me gusta construir interfaces que no solo se ven bien, sino que **funcionan de verdad**.
> Siempre buscando el balance perfecto entre **diseño** y **rendimiento**.
...
| 🖥️ **Backend** | ![PHP](https://img.shields.io/badge/PHP-777BB4?style=for-the-badge&logo=php&logoColor=white) ![Kotlin](https://img.shields.io/badge/Kotlin-7F52FF?style=for-the-badge&logo=kotlin&logoColor=white) |
...
###  ProyectoFinalWEB
> Aplicación web completa desarrollada con PHP
...
###  p_final_componentes
> Desarrollo de componentes Android con Kotlin
...
###  Portfolio Personal
> Mi sitio web personal y portafolio
...
###  *"El código limpio no es solo funcional, es una obra de arte que otros pueden leer."*
